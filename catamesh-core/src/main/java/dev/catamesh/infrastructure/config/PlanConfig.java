...
public class PlanConfig {
    ...
    public Factory<Void, Handler<PlanDataProductContext>> planDataProductChainFactory() {
        ...
        Handler<PlanDataProductContext> getCurrentDataProductHandler = new GetCurrentDataProductHandler<>(CQRSConfig.optionalDataProductQuery(), CQRSConfig.allResourcesQuery(), getResourceDefinitionQuery);
