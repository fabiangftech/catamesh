...
public class CheckIfExistResourceDefinitionVersionHandler extends Handler<ApplyDataProductContext> {
    ...
    public CheckIfExistResourceDefinitionVersionHandler(
    ...
    protected void doHandle(ApplyDataProductContext context) {
        for (Resource resource : context.getResources()) {
            ...
            boolean definitionAlreadyExists = optionalResourceDefinitionQuery.execute(
                    GetResourceDefinitionDTO.create(
                            resourceId,
                            definitionVersion
                    )
            ).isPresent();
